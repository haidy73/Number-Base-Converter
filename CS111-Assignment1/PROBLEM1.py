...
while True:
    #ask user to insert a new number or exit the program
    menu1_result = input("A) insert a new number\nB) Exit program\n").upper()
    if menu1_result == "B":
        break

    #show an error message and ask the user to choose a valid choice if the user choose an in valid choice
    while menu1_result != "A" and menu1_result != "B":
        print("please select a valid choice")
        menu1_result = input("A) insert a new number\nB) Exit program\n").upper()

    #start the program if the user chooses A, ask the user to insert a number and to choose the base they want to convert from
